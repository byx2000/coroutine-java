...
import byx.test.dispatcher.SystemCall;
...
import static byx.test.dispatcher.SystemCall.*;
...
public class DispatcherTest {
    ...
    public void testAwait() {
        ...
        Coroutine co1 = exec(() -> output.add("co1 begin"))
            .then(repeat(2, exec(() -> output.add("co1")).then(pause())))
            .then(() -> output.add("co1 end"))
            .toCoroutine();
        Coroutine co2 = exec(() -> output.add("co2 begin"))
            .then(repeat(3, exec(() -> output.add("co2")).then(pause())))
        ...
        Coroutine co3 = exec(() -> output.add("co3 begin"))
            ...
            .then(repeat(4, exec(() -> output.add("co3")).then(pause())))
    ...
    public void testCreateTask() {
        ...
        Coroutine co1 = exec(() -> output.add("co1 begin"))
            .then(repeat(3, exec(() -> output.add("co1")).then(pause())))
            .then(() -> output.add("co1 end"))
            .toCoroutine();
        Coroutine co2 = exec(() -> output.add("co2 begin"))
            .then(repeat(4, exec(() -> output.add("co2")).then(pause())))
            .then(() -> output.add("co2 end"))
            .toCoroutine();
        Coroutine co3 = exec(() -> output.add("co3 begin"))
            .then(createTask(co1))
            ...
            .then(repeat(6, exec(() -> output.add("co3")).then(pause())))
            .then(() -> output.add("co3 end"))
            .toCoroutine();
    ...
    public void testWait2() {
        ...
        Coroutine co1 = exec(() -> output.add("co1 begin"))
            .then(repeat(4, exec(() -> output.add("co1")).then(pause())))
            .then(() -> output.add("co1 end"))
            .then(value("hello"))
            .toCoroutine();
        Coroutine co2 = exec(() -> output.add("co2 begin"))
            .then(repeat(1, exec(() -> output.add("co2")).then(pause())))
            .then(() -> output.add("co2 end"))
            .then(value("hi"))
            .toCoroutine();
        Coroutine co3 = exec(() -> output.add("co3 begin"))
    ...
    public void testWIthContinuation3() {
        ...
        Coroutine co1 = exec(() -> output.add("co1 begin"))
            ...
            .toCoroutine();
        Coroutine co2 = exec(() -> output.add("co2 begin"))
            .then(repeat(5, exec(() -> output.add("co2")).then(pause())))
            .then(() -> output.add("co2 end"))
            .toCoroutine();
