...
class Calculator2 {
     ...
     * expr = term (+|- term)*
     */
    private static Thunk<Integer> evalExpr(String expr, AtomicInteger index) {
        int[] res = new int[]{0};
     ...
     * term = fact (*|/ fact)*
     */
    private static Thunk<Integer> evalTerm(String expr, AtomicInteger index) {
        int[] res = new int[]{0};
     ...
     *      | num
     */
    private static Thunk<Integer> evalFact(String expr, AtomicInteger index) {
        if (expr.charAt(index.get()) == '(') {
